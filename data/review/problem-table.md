...
| Q-FILENAME | 🟢 低 | 3 个策略文件名与 strategyId 不一致（文件叫 source-003/004/005.json，strategyId 却是 strategy-learning-...） | data/strategies/ 下 3 个文件 | 建议统一文件名，避免"来源 JSON 和策略 JSON 同名"的持续混淆 |
...
- ⚠️ source-002 孤儿（见 Q-SRC-002）；#11/#12 无步骤 chunk（见 Q-NOSTEP）
